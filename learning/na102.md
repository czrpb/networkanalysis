...
|<img alt="Clustering coefficient of a kite" src="images/net-ego-abc-bc-clustering.png" width="175" />|$\tau_{i}$|$k_{i}$|$CC_{i} = \frac {\tau_{i}} {\frac {k_{i}(k_{i}-1)} {2}}$|
|:---:|:---:|:---:|:---:|
...
|Clique: ego, b, c|||$\frac {\frac {7} {7}} {3} = 0.777$|
...
|||
|:---:|:---:|
|What communitites do you see?|<img alt="Zachary's Karate Club Network" src="images/net-karate_club.png" height="400"/>|
