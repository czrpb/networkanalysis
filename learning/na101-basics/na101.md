...
- Analytic (Slides 8-14)
  - Centrality
- Synthetic (Slides 15-19)
  - Density
  - Cliques
  - Components
- Small-worlds (Slides 22-23)
- Bonus / Random (Slide 24)
...
![A path, a geodesic, and a diameter](images/net-path-types.png)
...
|<img alt="Next Highest Density" src="images/net-ego-abcd-ab-cd-density.png" height="128"/>|$6$|$5$|$\frac {6} {\frac {5*4} {2}}$ -> $\frac {12} {20}$ -> $0.6$|
|<img alt="Highest Density" src="images/net-ego-abcd-connected-density.png" height="128"/>|$8$|$5$|$\frac {8} {\frac {5*4} {2}}$ -> $\frac {16} {20}$ -> $0.8$|
...
|||
|---|---|
|![3-Node Clique](images/net-clique-abc.png)|![5-Node Clique](images/net-clique-abcde.png)|

---

### Clusters

A *cluster* is a connected set of nodes. What is interesting is find the largest cluster.
...
- This presentation was written in markdown<sup>*</sup> and built with [marp](https://marp.app/).
